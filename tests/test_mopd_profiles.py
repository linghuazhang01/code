...
class MOPDProfileTests(unittest.TestCase):
    FORMAL_PROFILE_SPECS = (
        ("all", 2, 256, 2, 0.7, 64, 8),
        ("all", 4, 512, 4, 0.7, 64, 16),
        ("all", 6, 768, 2, 0.6, 64, 24),
        ("loss_only", 2, 256, 2, 0.7, 64, 8),
        ("loss_only", 4, 512, 4, 0.7, 64, 16),
        ("loss_only", 6, 768, 2, 0.6, 64, 24),
        ("loss_only", 8, 1024, 4, 0.7, 64, 32),
        ("off", 2, 256, 2, 0.7, 64, 8),
        ("off", 4, 512, 4, 0.7, 64, 16),
        ("off", 6, 768, 2, 0.6, 64, 24),
        ("off", 8, 1024, 4, 0.7, 64, 32),
    )
