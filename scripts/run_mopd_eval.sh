...
Examples:
  scripts/run_mopd_eval.sh configs/mopd_qwen4b_30b_a3b_instruct_2507_8gpu_math_code.yaml --dry-run

  scripts/run_mopd_eval.sh configs/mopd_qwen4b_30b_a3b_instruct_2507_8gpu_math_code.yaml \
