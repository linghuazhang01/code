"""Download official MMLU-Pro and SuperGPQA science benchmarks."""
...
DEFAULT_OUTPUT_DIR = Path("data/eval_data/science")
...
def resolve_dataset_keys(keys: list[str]) -> list[str]:
    ...
    if unknown:
        raise ValueError(f"Unknown science official datasets: {unknown}")
    return keys
