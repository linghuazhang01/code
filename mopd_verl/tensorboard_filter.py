...
CORE_TOKEN_WEIGHT = {
    ...
    "eligible_selection_score_count",
    "eligible_selection_score_max",
    "eligible_selection_score_mean",
    "eligible_selection_score_min",
    "eligible_selection_score_p10",
    "eligible_selection_score_p50",
    "eligible_selection_score_p90",
    "eligible_selection_score_std",
    ...
    "history_reset",
    "loss_ratio_other_occurrence_count",
    "loss_ratio_alpha",
    "loss_ratio_other_occurrence_mean_abs_loss",
    "loss_ratio_raw_selected_to_other",
    "loss_ratio_selected_occurrence_mean_abs_loss",
    "loss_ratio_selected_raw_weight",
    "loss_ratio_selected_unscaled_weight",
    "loss_ratio_weighting_enabled",
    "shared_occurrence_count",
    "shared_selection_is_cumulative",
    "selected_selection_score_count",
    "selected_selection_score_max",
    "selected_selection_score_mean",
    "selected_selection_score_min",
    "selected_selection_score_p10",
    "selected_selection_score_p50",
    "selected_selection_score_p90",
    "selected_selection_score_std",
...
CORE_ACTOR = {
    ...
    "actor/adaptive_threshold_is_strict",
    ...
    "actor/token_baseline_score_mean",
    "actor/token_baseline_selected_ratio",
    "actor/token_baseline_weight_mean",
